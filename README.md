...
The light intensity is detected via the color sensor channel 'c' in the *RP2040* board. My visualizer provides a cool indicator of the light intensity of the surroundings.
**Rule for the change**:
